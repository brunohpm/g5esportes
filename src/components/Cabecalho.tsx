  ...
  return (
    <header className="sticky top-0 z-50 bg-g5-950/95 text-white backdrop-blur-md">
      ...
      <div className="mx-auto flex h-18 max-w-7xl items-center gap-6 px-5 lg:px-8">
        <Link
          href="/"
          className="group flex shrink-0 items-baseline gap-2 font-display leading-none"
          aria-label={`${cfg.nomeSite ?? 'G5 Esportes'} — página inicial`}
        >
          <span className="text-4xl font-extrabold tracking-tight text-g5-200 transition-colors group-hover:text-white">
            G5
          </span>
          <span className="hidden text-xl font-semibold uppercase tracking-[0.18em] text-white/70 sm:block">
            Esportes
          </span>
        </Link>
